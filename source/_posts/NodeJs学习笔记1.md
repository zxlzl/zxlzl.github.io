...
&emsp;安装版本6.9.4。
&emsp;装完之后，在环境变量中查看
&emsp;![环境变量](http://img.blog.csdn.net/20171203141527438?)
...
&emsp;![安装后的node](http://img.blog.csdn.net/20171203141739359?)
 
&emsp;运行文件，就要用node命令来运行(进入node代码所在文件夹，使用node 相对地址)：
&emsp; ![挂起状态](http://img.blog.csdn.net/20171203141937348?)
